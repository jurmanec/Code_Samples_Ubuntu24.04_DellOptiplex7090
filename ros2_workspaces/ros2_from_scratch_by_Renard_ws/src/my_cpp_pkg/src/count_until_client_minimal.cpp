...
class CountUntilClientNode : public rclcpp::Node {
    ...
    void sendGoal(int target_number, double delay) {
        ...
        options.result_callback = std::bind(&CountUntilClientNode::goalResponsCallback, this, _1);
    ...
    // goal result
    void goalResponsCallback(const CountUntilGoalHandle::WrappedResult &result) {
